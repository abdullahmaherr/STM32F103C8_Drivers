 ...
 * Module : GPIO
 *
 * File Name : stm32f1xx_hal_gpio_driver.h
 *
...
void HAL_GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_PinConfig_t* p_PinConfig);
 ...
 * Return         : State of Pin.
 * Note           : None																				*/
PinState HAL_GPIO_ReadPin(GPIO_TypeDef *GPIOx, uint16_t a_PinNumber);
 ...
 * Return         : None.
 * Note           : None																				*/
void HAL_GPIO_WritePin(GPIO_TypeDef *GPIOx, uint16_t a_PinNumber, PinState a_Logic);

/**===============================================================================
 * Function Name  : HAL_GPIO_ReadPort.
...
/**===============================================================================
 * Function Name  : HAL_GPIO_WritePort.
 * Brief          : Function To Write Specific Port
 * Parameter (in) : GPIOx x Could Be A,B,C,D and E.
 * Parameter (in) : Value To be Written on The Port.
 * Return         : None.
 * Note           : None																				*/
void HAL_GPIO_WritePort(GPIO_TypeDef *GPIOx,uint16_t a_Value);
 ...
 * Return         : None.
 * Note           : None																				*/
void HAL_GPIO_TogglePin(GPIO_TypeDef *GPIOx, uint16_t a_PinNumber);

/**===============================================================================
 * Function Name  : HAL_GPIO_LockPin.
...
bool HAL_GPIO_LockPin(GPIO_TypeDef *GPIOx, uint16_t a_PinNumber);
